...
def test_model_registry():
    ...
    assert model_service_registry[ModelType.HUGGINGFACE_NER] == HuggingFaceNerModel
    assert model_service_registry[ModelType.HUGGINGFACE_LLM] == HuggingFaceLlmModel
